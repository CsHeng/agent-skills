...
4. Rerun the affected checks and all verification declared by the approved plan.
5. Do not invoke another review. If verification still fails or the repair reveals insufficient scope, return `non-convergent`, `replan`, `redesign`, or `needs-authority` as appropriate.
