...
`references/routing.toml` is portable authoring guidance for discovery behavior, semantic trigger ownership, support routes, and composition. It does not define a lifecycle, mode, phase sequence, review gate, or protocol for another product to consume.
