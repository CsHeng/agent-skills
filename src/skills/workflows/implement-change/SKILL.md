...
- Report semantic milestones and real evidence with explicit provenance. Keep acceptance a main-agent judgment: a host observation is not automatically a passing test, and a completed child apply is an integration fact, not acceptance. Use supported compound updates where appropriate rather than duplicating the same fact to satisfy internal bookkeeping.
