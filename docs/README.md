...
- `architecture/generated/*.svg` are the rendered human-facing views (harness routing sequence, implementation DAG, repair loop, skill planes). They are tracked, generated by `scripts/generate-workflow-diagrams.py`, and must not be edited by hand.
